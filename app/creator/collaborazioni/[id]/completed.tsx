...
export default function CompletedCollaborationView({
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const result = await submitCreatorReview(collaboration.id, rating, comment);
      if (!result) {
      ...
      <div className="mx-auto w-full max-w-4xl space-y-8">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            con {collaboration.business?.company_name}
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
              <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-50">
                Deliverable consegnati ({deliverables.length})
              </h2>
            ...
            {submissions.length > 0 && (
              <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
                <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-50">
                  Contenuti consegnati ({submissions.length})
                </h2>
                <div className="mt-3 space-y-2">
                  {submissions.map((s) => (
            ...
            {showReviewForm && (
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-6 dark:border-amber-900 dark:bg-amber-950">
                ...
                <p className="mt-1 text-sm text-amber-700 dark:text-amber-300">
                  Condividi il tuo feedback sulla collaborazione con {collaboration.business?.company_name}
                </p>
          ...
          {/* Business Card */}
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <h3 className="mb-3 text-lg font-semibold text-zinc-950 dark:text-zinc-50">Business</h3>
            ...
            <p className="font-semibold text-zinc-900 dark:text-zinc-100">
              {collaboration.business?.company_name}
            </p>
        ...
        {/* Back */}
        <Link href="/creator/collaborazioni" className="text-sm text-blue-600 dark:text-blue-400">
